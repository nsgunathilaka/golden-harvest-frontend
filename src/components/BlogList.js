  ...
  useEffect(() => {
    const fetchCrops = async () => {
      ...
      try {
        let url;
        if (selectedCenter) {
          url = `http://18.234.244.113:8000/api/api/get-centers-crop/${selectedCenter}/`;
        } else if (selectedDistrict) {
          url = `http://18.234.244.113:8000/api/api/district-data/${selectedDistrict}/`;
        } else {
          url = 'http://18.234.244.113:8000/api/api/get-all-crop/';
        }
